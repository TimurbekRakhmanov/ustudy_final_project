...
urlpatterns = [
    ...
    path('kitchen/orders/', ActiveOrderItemView.as_view(), name='active-order-list'),
    ...
    path('restaurants/<int:pk>/recipeitem/', RecipeItemViewSet.as_view(), name='recipeitem-page'),
    #path('restaurants/<int:pk>/recipeitem/<int:id>/', RecipeItemViewSet.as_view(), name='recipeitem-page'),
